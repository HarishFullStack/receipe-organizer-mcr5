        ...
        <div>
            <div className="row" style={{margin: "0.5rem"}}>
                <div className="input-group mb-3">
                    <input type="text" className="form-control" placeholder="Search the item you want" aria-label="Recipient's username" aria-describedby="basic-addon2"/>
                    <span className="input-group-text" id="basic-addon2">
                        Filters: <input type="radio" name="filter" onClick={() => dispatch({type: "search", value: "name"})}/> Name
                        <input type="radio" name="filter" onClick={() => dispatch({type: "search", value: "ingredients"})}/> Ingredients
                        <input type="radio" name="filter" onClick={() => dispatch({type: "search", value: "cuisine"})}/> Cuisine</span>
                </div>
            </div>
            <div className="row">
            {
